...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lbyl;->b:Ljava/lang/ThreadLocal;
    ...
    sput-object v0, Lbyl;->c:Ljava/lang/ThreadLocal;
    ...
    sput-object v0, Lbyl;->d:Ljava/lang/ThreadLocal;
    ...
    sput-object v0, Lbyl;->a:Ljava/lang/ThreadLocal;
...
.method public static c(Landroid/graphics/Matrix;)F
    ...
    sget-object v0, Lbyl;->a:Ljava/lang/ThreadLocal;
...
.method public static g(Landroid/graphics/Path;Lbtw;)V
    .locals 3

    if-eqz p1, :cond_1

    iget-boolean v0, p1, Lbtw;->a:Z
    ...
    iget-object v2, p1, Lbtw;->c:Lbuc;

    check-cast v2, Lbue;

    .line 2
    invoke-virtual {v2}, Lbue;->k()F

    move-result v2

    div-float/2addr v2, v1

    iget-object p1, p1, Lbtw;->d:Lbuc;

    check-cast p1, Lbue;

    .line 3
    invoke-virtual {p1}, Lbue;->k()F
    ...
    .line 4
    invoke-static {p0, v0, v2, p1}, Lbyl;->h(Landroid/graphics/Path;FFF)V
...
.method public static h(Landroid/graphics/Path;FFF)V
    ...
    sget-object v0, Lbyl;->b:Ljava/lang/ThreadLocal;
    ...
    sget-object v1, Lbyl;->c:Ljava/lang/ThreadLocal;
    ...
    sget-object v2, Lbyl;->d:Ljava/lang/ThreadLocal;
    ...
    .line 10
    invoke-static {v4, v3}, Lbyg;->d(FF)I
    ...
    .line 11
    invoke-static {p1, v3}, Lbyg;->d(FF)I
...
.method public static j(Landroid/graphics/Canvas;Landroid/graphics/RectF;Landroid/graphics/Paint;)V
    .locals 1

    const/16 v0, 0x1f

    .line 1
    invoke-static {p0, p1, p2, v0}, Lbyl;->k(Landroid/graphics/Canvas;Landroid/graphics/RectF;Landroid/graphics/Paint;I)V

    return-void
.end method

.method public static k(Landroid/graphics/Canvas;Landroid/graphics/RectF;Landroid/graphics/Paint;I)V
    .locals 2
