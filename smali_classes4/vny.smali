...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lvny;->ag:Ljava/lang/Object;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lvny;->ah:Z
...
.method private final aJ()V
    ...
    iget-object v0, p0, Lvny;->ae:Landroid/content/ContextWrapper;

    if-nez v0, :cond_0

    invoke-super {p0}, Luwa;->ra()Landroid/content/Context;
    ...
    iput-object v0, p0, Lvny;->ae:Landroid/content/ContextWrapper;
...
.method public final S(Landroid/app/Activity;)V
    ...
    .line 1
    invoke-super {p0, p1}, Luwa;->S(Landroid/app/Activity;)V
    ...
    .line 3
    invoke-direct {p0}, Lvny;->aJ()V

    .line 4
    invoke-virtual {p0}, Lvny;->aI()V
...
.method public final aH()Lawqs;
    ...
    iget-object v0, p0, Lvny;->af:Lawqs;

    if-nez v0, :cond_1

    iget-object v0, p0, Lvny;->ag:Ljava/lang/Object;

    .line 1
    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lvny;->af:Lawqs;
    ...
    iput-object v1, p0, Lvny;->af:Lawqs;
...
.method protected final aI()V
    ...
    .line 1
    invoke-virtual {p0}, Lvny;->lL()Ljava/lang/Object;
    ...
    iput-object v2, v1, Lvoa;->ae:Lafhx;
    ...
    iput-object v0, v1, Lvoa;->af:Lydi;
...
.method public final getDefaultViewModelProviderFactory()Lai;
    ...
    .line 1
    invoke-super {p0}, Luwa;->getDefaultViewModelProviderFactory()Lai;
...
.method public final kt(Landroid/content/Context;)V
    ...
    .line 1
    invoke-super {p0, p1}, Luwa;->kt(Landroid/content/Context;)V
...
.method public final bridge synthetic lK()Lawrb;
    ...
    .line 1
    invoke-virtual {p0}, Lvny;->aH()Lawqs;
...
.method public final lX(Landroid/os/Bundle;)Landroid/view/LayoutInflater;
    ...
    .line 1
    invoke-super {p0, p1}, Luwa;->lX(Landroid/os/Bundle;)Landroid/view/LayoutInflater;
