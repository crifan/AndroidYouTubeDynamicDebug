...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lkxi;->ah:Ljava/lang/Object;

    const/4 v0, 0x0

    iput-boolean v0, p0, Lkxi;->aj:Z
...
.method private final aK()V
    ...
    iget-object v0, p0, Lkxi;->af:Landroid/content/ContextWrapper;

    if-nez v0, :cond_0

    invoke-super {p0}, Lbed;->ra()Landroid/content/Context;
    ...
    iput-object v0, p0, Lkxi;->af:Landroid/content/ContextWrapper;
...
.method public final S(Landroid/app/Activity;)V
    ...
    .line 1
    invoke-super {p0, p1}, Lbed;->S(Landroid/app/Activity;)V
    ...
    .line 3
    invoke-direct {p0}, Lkxi;->aK()V

    .line 4
    invoke-virtual {p0}, Lkxi;->aM()V

    return-void
.end method

.method public final aL()Lawqs;
    .locals 2

    iget-object v0, p0, Lkxi;->ag:Lawqs;

    if-nez v0, :cond_1

    iget-object v0, p0, Lkxi;->ah:Ljava/lang/Object;

    .line 1
    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Lkxi;->ag:Lawqs;
    ...
    iput-object v1, p0, Lkxi;->ag:Lawqs;
...
.method protected final aM()V
    ...
    .line 1
    invoke-virtual {p0}, Lkxi;->lL()Ljava/lang/Object;
    ...
    iget-object v0, v0, Ldqy;->aZ:Laypi;

    iput-object v0, v1, Lkxe;->af:Laypi;
...
.method public final getDefaultViewModelProviderFactory()Lai;
    ...
    .line 1
    invoke-super {p0}, Lbed;->getDefaultViewModelProviderFactory()Lai;
...
.method public final kt(Landroid/content/Context;)V
    ...
    .line 1
    invoke-super {p0, p1}, Lbed;->kt(Landroid/content/Context;)V
...
.method public final bridge synthetic lK()Lawrb;
    ...
    .line 1
    invoke-virtual {p0}, Lkxi;->aL()Lawqs;
...
.method public final lX(Landroid/os/Bundle;)Landroid/view/LayoutInflater;
    ...
    .line 1
    invoke-super {p0, p1}, Lbed;->lX(Landroid/os/Bundle;)Landroid/view/LayoutInflater;
