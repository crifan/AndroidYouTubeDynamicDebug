...
.method static constructor <clinit>()V
    ...
    :cond_0
    :goto_0
    sput-object v0, Laub;->b:Ljava/lang/reflect/Constructor;
...
.method private static final b(ILjava/util/List;)V
    ...
    .line 3
    invoke-direct {p0, v1}, Lazd;-><init>([B)V
    ...
    invoke-direct {p0, v1}, Lawu;-><init>([B)V

    invoke-interface {p1, p0}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance p0, Lawx;

    .line 7
    invoke-direct {p0, v1}, Lawx;-><init>([B)V
    ...
    .line 8
    invoke-direct {p0, v1}, Lawd;-><init>([B)V
    ...
    .line 10
    :pswitch_a
    sget-object p0, Laub;->b:Ljava/lang/reflect/Constructor;
    ...
    .line 12
    :cond_0
    new-instance p0, Lavf;

    .line 14
    invoke-direct {p0, v1}, Lavf;-><init>([B)V
    ...
    .line 16
    invoke-direct {p0, v1}, Lavc;-><init>([B)V
    ...
    :pswitch_c
    new-instance p0, Laxx;

    .line 17
    invoke-direct {p0, v1}, Laxx;-><init>([B)V
...
# virtual methods
.method public final declared-synchronized a(Landroid/net/Uri;Ljava/util/Map;)[Laud;
    .locals 18
    ...
    .line 4
    :cond_2
    invoke-static {v3}, Lppm;->h(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 5
    invoke-static {v3, v0}, Laub;->b(ILjava/util/List;)V
    ...
    .line 37
    invoke-static {v15, v0}, Laub;->b(ILjava/util/List;)V
    ...
    .line 39
    invoke-static {v5, v0}, Laub;->b(ILjava/util/List;)V
