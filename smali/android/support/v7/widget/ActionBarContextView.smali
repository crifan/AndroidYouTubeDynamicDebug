...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    .line 3
    invoke-direct {p0, p1, p2, p3}, Ltm;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    .line 4
    sget-object v0, Lps;->d:[I
    ...
    .line 6
    invoke-virtual {p1, p2, v1}, Laam;->f(II)I
    ...
    .line 8
    invoke-virtual {p1, p2, v1}, Laam;->e(II)I
    ...
    .line 9
    invoke-virtual {p1, p2, p3}, Laam;->f(II)I
...
.method public final h(Lrm;)V
    ...
    .line 7
    invoke-direct {v2, p1}, Lto;-><init>(Lrm;)V

    invoke-virtual {v0, v2}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    invoke-virtual {p1}, Lrm;->a()Landroid/view/Menu;

    move-result-object p1

    iget-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Ltz;
    ...
    invoke-direct {v0, v2}, Ltz;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Ltz;

    iget-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Ltz;

    .line 10
    invoke-virtual {v0}, Ltz;->p()V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Ltz;
    ...
    .line 12
    invoke-virtual {p1, v2, v3}, Lso;->h(Ltc;Landroid/content/Context;)V

    iget-object p1, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Ltz;

    iget-object v2, p1, Ltz;->f:Lte;

    iget-object v3, p1, Lsb;->f:Lte;

    if-nez v3, :cond_3

    iget-object v3, p1, Lsb;->d:Landroid/view/LayoutInflater;
    ...
    iput-object v1, p1, Lsb;->f:Lte;

    iget-object v1, p1, Lsb;->f:Lte;

    iget-object v3, p1, Lsb;->c:Lso;

    .line 14
    invoke-interface {v1, v3}, Lte;->a(Lso;)V
    ...
    invoke-virtual {v2, p1}, Landroid/support/v7/widget/ActionMenuView;->h(Ltz;)V
    ...
    .line 17
    invoke-static {p1, v1}, Llo;->O(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
...
.method public final onDetachedFromWindow()V
    ...
    .line 1
    invoke-super {p0}, Ltm;->onDetachedFromWindow()V
...
.method public final bridge synthetic onHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 1
    invoke-super {p0, p1}, Ltm;->onHoverEvent(Landroid/view/MotionEvent;)Z
...
.method public final onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    .line 6
    :cond_0
    invoke-super {p0, p1}, Ltm;->onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
...
.method public final bridge synthetic onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    .line 1
    invoke-super {p0, p1}, Ltm;->onTouchEvent(Landroid/view/MotionEvent;)Z
