...
.method public static a(Lctn;)Lctc;
    .locals 2
    ...
    invoke-virtual {v0, p0, v1}, Lctc;->h(Lctn;Lctd;)V
...
.method protected final c(Lctn;)Lctr;
    ...
    iget-object v1, p0, Lctd;->b:Lcom/facebook/yoga/YogaAlign;
    ...
    :cond_1
    iget-object v1, p0, Lctd;->c:Lcom/facebook/yoga/YogaAlign;
    ...
    :cond_2
    iget-object v1, p0, Lctd;->d:Lcom/facebook/yoga/YogaJustify;
    ...
    :cond_3
    iget-object v1, p0, Lctd;->e:Lcom/facebook/yoga/YogaWrap;
    ...
    :cond_4
    iget-object v1, p0, Lctd;->a:Ljava/util/List;
...
.method public final e(Lctj;)Z
    ...
    :cond_2
    iget-object v2, p0, Lctd;->a:Ljava/util/List;

    if-eqz v2, :cond_6

    iget-object v3, p1, Lctd;->a:Ljava/util/List;
    ...
    iget-object v4, p0, Lctd;->a:Ljava/util/List;
    ...
    iget-object v5, p1, Lctd;->a:Ljava/util/List;
    ...
    .line 7
    :cond_6
    iget-object v2, p1, Lctd;->a:Ljava/util/List;
    ...
    .line 4
    :cond_7
    iget-object v2, p0, Lctd;->b:Lcom/facebook/yoga/YogaAlign;

    if-eqz v2, :cond_8

    iget-object v3, p1, Lctd;->b:Lcom/facebook/yoga/YogaAlign;
    ...
    .line 7
    :cond_8
    iget-object v2, p1, Lctd;->b:Lcom/facebook/yoga/YogaAlign;
    ...
    :cond_a
    :goto_2
    iget-object v2, p0, Lctd;->c:Lcom/facebook/yoga/YogaAlign;

    if-eqz v2, :cond_b

    iget-object v3, p1, Lctd;->c:Lcom/facebook/yoga/YogaAlign;
    ...
    .line 7
    :cond_b
    iget-object v2, p1, Lctd;->c:Lcom/facebook/yoga/YogaAlign;
    ...
    :cond_d
    :goto_3
    iget-object v2, p0, Lctd;->d:Lcom/facebook/yoga/YogaJustify;

    if-eqz v2, :cond_e

    iget-object v3, p1, Lctd;->d:Lcom/facebook/yoga/YogaJustify;
    ...
    :cond_e
    iget-object v2, p1, Lctd;->d:Lcom/facebook/yoga/YogaJustify;
    ...
    :cond_10
    :goto_4
    iget-boolean v2, p0, Lctd;->f:Z

    iget-boolean p1, p1, Lctd;->f:Z
