...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Loaw;->ag:Ljava/lang/Object;

    const/4 v0, 0x0

    iput-boolean v0, p0, Loaw;->ah:Z
...
.method private final aM()V
    ...
    iget-object v0, p0, Loaw;->ae:Landroid/content/ContextWrapper;

    if-nez v0, :cond_0

    invoke-super {p0}, Lben;->ra()Landroid/content/Context;
    ...
    iput-object v0, p0, Loaw;->ae:Landroid/content/ContextWrapper;
...
.method public final S(Landroid/app/Activity;)V
    ...
    .line 1
    invoke-super {p0, p1}, Lben;->S(Landroid/app/Activity;)V
    ...
    .line 3
    invoke-direct {p0}, Loaw;->aM()V

    .line 4
    invoke-virtual {p0}, Loaw;->aL()V
...
.method public final aK()Lawqs;
    ...
    iget-object v0, p0, Loaw;->af:Lawqs;

    if-nez v0, :cond_1

    iget-object v0, p0, Loaw;->ag:Ljava/lang/Object;

    .line 1
    monitor-enter v0

    :try_start_0
    iget-object v1, p0, Loaw;->af:Lawqs;
    ...
    iput-object v1, p0, Loaw;->af:Lawqs;
...
.method protected final aL()V
    ...
    .line 1
    invoke-virtual {p0}, Loaw;->lL()Ljava/lang/Object;
    ...
    iput-object v0, v1, Lobk;->af:Lobr;
...
.method public final getDefaultViewModelProviderFactory()Lai;
    ...
    .line 1
    invoke-super {p0}, Lben;->getDefaultViewModelProviderFactory()Lai;
...
.method public final kt(Landroid/content/Context;)V
    ...
    .line 1
    invoke-super {p0, p1}, Lben;->kt(Landroid/content/Context;)V
...
.method public final bridge synthetic lK()Lawrb;
    ...
    .line 1
    invoke-virtual {p0}, Loaw;->aK()Lawqs;
...
.method public final lX(Landroid/os/Bundle;)Landroid/view/LayoutInflater;
    ...
    .line 1
    invoke-super {p0, p1}, Lben;->lX(Landroid/os/Bundle;)Landroid/view/LayoutInflater;
